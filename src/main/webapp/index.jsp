...
<head>
   ...
   以/开始的相对路径，找资源，以服务器的路径为标准(http://localhost:8080)加上项目名
...
<div class="container">
    ...
    <script type="text/javascript">
        ...
        //1)、可以在创建按钮的时候绑定事件  2)、绑定点击事件.live()
        //jquery没有live，使用on进行替代
